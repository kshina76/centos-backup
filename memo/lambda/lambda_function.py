...
# {($.serviceEventDetails.createManagedAccountStatus.state=SUCCEEDED || $.serviceEventDetails.createManagedAccountStatus.state=FAILED) && ($.userIdentity.accountId=343310143635)}
