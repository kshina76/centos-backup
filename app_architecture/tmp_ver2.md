# アプリケーションアーキテクチャ
<!-- TOC -->autoauto- [アプリケーションアーキテクチャ](#アプリケーションアーキテクチャ)auto  - [アプリケーションの種類と開発パターン](#アプリケーションの種類と開発パターン)auto    - [IOS, Androidアプリケーション](#ios-androidアプリケーション)auto    - [Webアプリケーション](#webアプリケーション)auto  - [GUIアーキテクチャとシステムアーキテクチャ](#guiアーキテクチャとシステムアーキテクチャ)auto  - [アーキテクチャの選択](#アーキテクチャの選択)auto    - [小規模](#小規模)auto    - [中規模](#中規模)auto    - [大規模](#大規模)auto    - [マイクロサービスアーキテクチャ](#マイクロサービスアーキテクチャ)autoauto<!-- /TOC -->
