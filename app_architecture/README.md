...
- アーキテクチャ早見表
    - 3層
        ...
        ![2020-11-17 1 50のイメージ](https://user-images.githubusercontent.com/53253817/99282744-6f645e00-2877-11eb-9bfe-59a989e524c0.jpeg)
    ...
    - レイヤードアーキテクチャ(4層)
        ...
        - データアクセス層
            ...
            - 返り値はドメイン層へ
    - オニオンアーキテクチャ
        - レイヤードアーキテクチャの弱点であるビジネスロジック層がデータアクセス層に依存している点を解消
        - レイヤードアーキテクチャのデータアクセス層(Infrastructures層)にDIPを使って依存方向を逆にしたもの
    - クリーンアーキテクチャ
        - オニオンアーキテクチャの層の名前が変わっただけ？
...
- アプリケーションをレイヤーに分けることのメリット
    - トラブルシューティングが楽になる
        - MySQLで問題が発生したからInfrastructure層のコードを調査だ！という感じ
    - 変更に対して強い
        - DBをMySQLの他にPostgreSQLも使いたい！となったらIfrastructure層のコードを変更すればいいのかとすぐわかる
