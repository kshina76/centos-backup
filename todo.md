...
- 論文追加すること
  ...
  - ディザを混ぜた際の信号の画像など
  - 文献20個以上
  - ディザを大元のところから引用(概要のやつかな？)
  - 全ての図の文献を記述する
  - DenoisingWaveNetの説明の充実
- 英語や文章題の解き方
  - https://www.youtube.com/watch?v=Nuo0HCc4YV8
- 5歳までどちらかの親がつきっきりでいることがコスパがいい
  - https://www.youtube.com/watch?v=C_8ZoGgN46k
- wavenetのreceptive fieldの計算方法
  - (2^0+2^1+...+2^9)*(stack数)*2+1
    - 「2」はDenoisingWaveNetは通常のWaveNetの未来の信号も含めるので、2倍するという意味
    - 「1」は現在の信号の部分を足す必要があるから
  - https://github.com/ibab/tensorflow-wavenet/issues/259
